...
guns3d.register_magazine("no2.png", "50R STANAG (5.56x39mm)", "3dguns:extended_stanag", {"default:wood", "default:acacia_wood"}, 50) --these functions need a more clear def table.
...
guns3d.register_gun("3dguns:m4a1", {
    description = "m4",
    recoil_vel = {look_axial={x=.2, y=.2}, gun_axial={x=.05, y=.05}}, --the velocity that will be added when the gun is fired
    ...
    sway_vel = {look_axial=.1, gun_axial=.1}, --the velocity the gun will drift away from center aim (this doesn't effect non-sway offsets)
    sway_max = {look_axial=.2, gun_axial=.05}, --the maximum angle that the gun will drift to before changing velocity
